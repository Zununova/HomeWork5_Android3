...
class EpisodeRepository {
    ...
    suspend fun fetchEpisode(): Flow<PagingData<EpisodeModel>> {
        return Pager(
            config = PagingConfig(
                pageSize = 10,
    ...
    fun fetchSingleEpisode(id: Int): Flow<EpisodeModel?> = callbackFlow {
        ...
        App.episodeApiService?.fetchIdEpisode(id)?.enqueue(callback)
